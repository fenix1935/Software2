...
import com.example.vo.VOPalabras;
...
public class PresentadorPalabras extends AppCompatActivity {
    ListView opciones;
    private ArrayAdapter<String> adapter;
    public static ArrayList<VOPalabras> gPi;
    String a;
    EditText subirI;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_palabras_clave);
        ...
        opciones=(ListView)findViewById(R.id.listaPalabras);
        adapter= new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1);
        opciones.setAdapter(adapter);
        subirI= findViewById(R.id.editPalabras);
        ejecutarTarea12();
    ...
    public void botonPalabra(View view){
        Subir();
        subirI.setText("");
        // IdeaGet();
    }
    ...
    public void IdeaGet(){
        ...
        datos.put("num4", AsignacionGrupo.numG);
        JSONObject jsonData = new JSONObject(datos);
        AndroidNetworking.post(MainActivity.port+":8080/Proyecto/restJR/Activity/PalabrasGet").
                addJSONObjectBody(jsonData).
                setPriority(Priority.MEDIUM)
                .build()
                .getAsString(new StringRequestListener() {
                    ...
                    public void onResponse(String response) {
                        try {
                            adapter.clear();
                            Gson gson= new Gson();
                            gPi= new ArrayList<VOPalabras>();
                            Type userListType = (new TypeToken<ArrayList<VOPalabras>>(){}).getType();
                            gPi= gson.fromJson(response, userListType);
                            //System.out.println(g.size());
                            //System.out.println(g.get(1).getNombreCurso());
                            for(int i=0; i<gPi.size();i++){
                                String a= gPi.get(i).getPalabras();
                                adapter.add(gPi.get(i).getPalabras());
                            }
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (estado.equals("15")) {
                                ...
                                Intent intent = new Intent(PresentadorPalabras.this, PresentadorIdeas2.class);
                                startActivity(intent);
                                //Código importante.
